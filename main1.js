...
function showtask(){
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    <td><button type="button" class="text-success" id=${index}><i class="bi bi-check-circle-fill"></i>Complete</button></td>
                    <td><button type="button" onclick="deleteitem(${index})" class="text-danger"><i class="bi bi-trash-fill"></i>Delete</button></td>
                </tr>`;
    });
...
function deleteitem(index){
    ...
    if (confirm("Are you sure want to delete this item from list?"))
...
deleteallbtn.addEventListener("click", function(e){
    ...
    let addtaskbtn = document.getElementById("addtaskbtn");
    let webtask = localStorage.getItem("localtask");
    let taskObj = JSON.parse(webtask);  e.preventDefault();
